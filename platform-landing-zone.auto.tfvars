...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name               = "rgbdo4-management-$${starter_location_01}"
    connectivity_hub_vwan_resource_group_name    = "rgbdo4-hub-vwan-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name = "rgbdo4-hub-$${starter_location_01}"
    dns_resource_group_name                      = "rgbdo4-hub-dns-$${starter_location_01}"
    # ddos_resource_group_name                     = "rgbdo4-hub-ddos-$${starter_location_01}"
    asc_export_resource_group_name               = "rgbdo4-asc-export-$${starter_location_01}"

    # Resource names
    log_analytics_workspace_name            = "bdo4law-management-$${starter_location_01}"
    # ddos_protection_plan_name               = "bdo4ddos-$${starter_location_01}"
    automation_account_name                 = "bdo4aa-management-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "bdo4uami-management-ama-$${starter_location_01}"
    dcr_change_tracking_name                = "bdo4dcr-change-tracking"
    dcr_defender_sql_name                   = "bdo4dcr-defender-sql"
    dcr_vm_insights_name                    = "bdo4dcr-vm-insights"

    # Resource names primary connectivity
    primary_hub_name                                   = "bdo4vwan-hub-$${starter_location_01}"
    primary_sidecar_virtual_network_name               = "bdo4vnet-sidecar-$${starter_location_01}"
    primary_firewall_name                              = "bdo4fw-hub-$${starter_location_01}"
    primary_firewall_policy_name                       = "bdo4fwp-hub-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_name = "bdo4vgw-hub-er-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_name           = "bdo4vgw-hub-vpn-$${starter_location_01}"
    primary_private_dns_resolver_name                  = "bdo4pdr-hub-dns-$${starter_location_01}"
    # primary_bastion_host_name                          = "bdo4bas-hub-$${starter_location_01}"
    # primary_bastion_host_public_ip_name                = "bdo4pip-bastion-hub-$${starter_location_01}"
...
tags = {
  ...
  source      = "BDO4 Azure Landing Zones Accelerator"
}
